...
$$
\vec{F}_{mag}\cdot d\vec{l}=\vec{F}_{mag}\cdot\vec{v}dt=0
$$
...
$$
\vec{B}(r)=\frac{\mu_0}{4\pi}\int\frac{\vec{I}\times\hat{\zeta}}{\zeta^2}dl'=\frac{\mu_0}{4\pi}I\int\frac{d\vec{l}'\times\hat{\zeta}}{\zeta^2}
$$
